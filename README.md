...
| **4 — Subagents** | `agents/` | When invoked by a playbook | Subagent definitions deployed to target as `.devin/agents/` for Devin |
...
agents/                                 Tier 4 — subagent definitions (→ target .devin/agents/ for Devin)
